...
class OrderForm extends Form {
	...
	function __construct($controller, $name) {
		...
		if(!$member->ID || $member->Password == '') {
			...
			$rightFields->push(new LiteralField('MemberInfo', "<p class=\"message good\">If you are already a member, please <a href=\"Security/login?BackURL=" . CheckoutPage::find_link(true) . "/\">login</a>.</p>"));
